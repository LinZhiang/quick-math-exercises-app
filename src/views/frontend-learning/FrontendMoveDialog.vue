...
const excludeIds = computed(() =>
  props.movingKind === 'branch' ? frontendNodeExcludeSet(props.tree, props.movingId) : new Set<string>(),
)

function mapFolders(nodes: FrontendTreeNode[]): MoveTreeNode[] {
