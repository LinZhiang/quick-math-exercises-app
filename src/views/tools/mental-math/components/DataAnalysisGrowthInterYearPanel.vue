...
} from '@/composables/useDataAnalysisGrowthInterYearTest'
...
import DataAnalysisGrowthInterYearChart from '@/views/tools/mental-math/components/DataAnalysisGrowthInterYearChart.vue'
