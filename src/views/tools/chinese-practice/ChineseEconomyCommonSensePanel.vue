...
import { useChineseEconomyCommonSenseTest } from '@/composables/chinese/useChineseEconomyCommonSenseTest'
...
defineExpose({
  ...
  startWith(questions: EconomyCommonSenseQuestion[], keyReview?: ChineseKeyReviewMeta) {
    test.resetToIdle()
