  ...
  <div v-if="open" class="vr-panel">
      ...
      <section class="vr__block">
        ...
        <ul class="vr__list">
          <li v-for="(c, i) in pack.confusables" :key="i" class="vr__list-item">
            ...
            <p class="vr__line">
              <strong>正确字音/字形：</strong>{{ c.correctFormOrReading }}
            </p>
      ...
      <section class="vr__block">
        ...
        <ul v-if="pack.otherOptions.length" class="vr__list">
          <li v-for="(o, i) in pack.otherOptions" :key="i" class="vr__list-item">
            ...
            <p class="vr__line">
              <strong>正确字音/字形：</strong>{{ o.correctFormOrReading }}
            </p>
            <p class="vr__line"><strong>易混点：</strong>{{ o.confusionPoint }}</p>
          </li>
        </ul>
        <p v-else class="vr__muted">暂无其他选项说明。</p>
      </section>
    ...
    <template v-else-if="phase === 'quiz' && currentQuiz">
      <div class="vr__quiz-head">
        <span class="vr__badge">
          {{ charLiteracyRelatedQuizTypeLabel(currentQuiz.questionType) }}
        </span>
      ...
      <p class="vr__muted vr__hint">学后小测只考字音/字形，不计入错题本</p>
      <div class="vr__actions">
