...
defineExpose({
  ...
  startWith(questions: PartyHistoryQuestion[], keyReview?: ChineseKeyReviewMeta) {
    test.resetToIdle()
...
<template>
  <div class="chinese-idiom-panel">
    <template v-if="test.phase === 'idle' || test.phase === 'loading'">
      ...
      <p class="practice-completion-line"><PracticeCompletionStat mode-id="chinese-party-history" /></p>
