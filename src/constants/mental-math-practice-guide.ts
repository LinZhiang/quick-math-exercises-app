    ...
    articles: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '快判本地题：先在舒尔特方格上按序高亮目标字 2 秒（此时不计时），熄灭后再按同样顺序点选。干扰键为形近/易混字。题库 200 条（成语与公考常用词语各半）。',
          },
          {
            type: 'h3',
            text: '怎么练',
          },
          {
            type: 'ul',
            items: [
              '简单题：40 秒，4×5 格，对 +10 / 错 −20。',
              '复杂题：80 秒，5×7 格，对 +15 / 错 −30。',
          ...
          {
            type: 'tip',
            text: '预览时盯住格子上的高亮顺序，点选时一次只找下一个字。',
          },
        ],
      },
    ],
