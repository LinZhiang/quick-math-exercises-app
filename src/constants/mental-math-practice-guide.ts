...
export const MENTAL_MATH_GUIDE_GROUPS: MentalMathGuideGroup[] = [
    ...
    articles: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '个位数连加减，形如 7 + 2 − 5 + 1。简单题 3～4 个数（对 +8 / 错 −16），复杂题 5～6 个数。干扰项常是「某一处加减反了」或与正确答案只差 1～2。',
          },
          {
            type: 'h3',
            text: '怎么算更快',
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '百分数直接加减，如 35% + 28%、72.5% − 19.3%。简单题约三成带一位小数；复杂题一律带一位或两位小数。四个选项：正确项 + 末位错 / 倒数第二位错 / 两位都错（末位与「仅末位错」一致，如 16.6% → 15.6%、16.7%、15.7%）。',
          },
          {
            type: 'h3',
            text: '怎么算更快',
    ...
    articles: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '这里是口算菜单里的「生活常识」快判题（材料、种属、组成、用途、别称，交通安全/健康饮食等扩展题，以及古代音乐/戏曲/科技等专题），和语文里的「生活科学」不是同一套。题干短、选项短，靠常识反应。同一难度会优先出尚未做过的题，全部出完后自动重置再循环。',
          },
          {
            type: 'h3',
            text: '三种难度',
          },
          {
            ...
            items: [
              '简单：小学/日常能接触的名称与现象。',
              '普通：初中常识、易混但不超纲。',
              '复杂：高中/公考常见进阶；不做冷门曲牌考据、过专乐律术语、伪考证冷知识。',
              '抽题优先出本难度题库里还没出过的题；该难度全部出过一轮后会重置进度再随机抽。',
              '作答过程中只显示对错；详细错因可在本局结束后或错题集里看。',
              '「加深识记」：按难度打开固定分组目录（每组 20 题，组号可溯源），先看解析再限时测同组（简单 65 秒 / 普通 77 秒 / 复杂 89 秒）；点选项即判定，测完看答题结果；答错进错题本。',
            ],
          },
          {
            type: 'h3',
          ...
          },
          {
            type: 'ul',
            items: [
              '先读完题干再看选项，避免被近义干扰项带走。',
              '拿不准时排除明显离谱项，再在剩余项里靠语感选。',
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    articles: [
      {
        id: 'what-is-this-overview',
        title: '怎么练「这是什么」',
        category: 'what-is-this',
        practiceModeId: 'what-is-this-easy',
        blocks: [
          {
            type: 'p',
            text: '题干固定为「什么是××」，选项是对该专有名词的释义。干扰项来自同难度其他专有名词的真实释义，读起来也像专业解释，靠辨认核心含义作答。流程与计分与「生活常识」一致。',
          },
          {
            type: 'h3',
            text: '三种难度',
          },
          {
            type: 'ul',
            items: [
              '简单：日常会碰到但不至于「医生/老师」那种过浅的词，如宪法、律师、会计、秘书、护照、发票等。',
              '普通：经管法务常见专名，如有限公司、通货膨胀、监察机关、劳动合同、存款准备金等。',
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          },
          {
            type: 'ul',
            items: [
              '仅「普通题」：52 秒限时，四选一，对 +8 / 错 -15；优先出未做过的知识点，出完重置再循环。',
              '「加深识记」：按固定分组（每组最多 20 题）先看定义与举例，再限时测同组（满组 77 秒）；解析可编辑覆盖。',
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          },
          {
            type: 'ul',
            items: [
              '仅「普通题」：52 秒四选一，对 +8 / 错 -15；优先未做过知识点。',
              '「加深识记」：固定分组先看解析（含举例/易错）再限时测同组（满组 77 秒）。',
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          },
          {
            type: 'ul',
            items: [
              '仅「普通题」：52 秒四选一，对 +8 / 错 -15；优先未做过知识点，出完重置再循环。',
              '「加深识记」：固定分组（每组最多 20 题）先看类别、例句与义项，再限时测同组（满组 77 秒）；解析可编辑覆盖。',
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          },
          {
            type: 'ul',
            items: [
              '「普通题」：117 秒四选一，对 +8 / 错 -15；优先未做过知识点。',
              '「加深识记」：固定分组先看例句/用法/译文，再限时测同组（满组 142 秒；题序乱序）。',
    ...
    articles: [
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              '「普通题」：117 秒四选一，对 +8 / 错 -15；优先未做过知识点。',
              '「加深识记」：固定分组先识记再限时测（满组 142 秒；题序乱序）。',
    ...
    articles: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '看一句，选出主要修辞。句子来自诗词名句或政论表述。和语文里的「修辞运用」不是同一套。',
          },
          {
            type: 'h3',
            text: '只考这 10 种',
          ...
          },
          {
            type: 'ul',
            items: [
              '普通题：52 秒，四选一；对加 8 分，错扣 15 分。',
              '加深识记：先看要点和例句，再限时测同组。',
              '每种约 30 题，共 300 题；优先出没做过的。',
            ],
          },
          {
            type: 'tip',
            text: '先抓标志：问号看设问或反问；「像、是」常是比喻；物当人常是比拟。',
          },
        ],
      },
    ],
