...
export const MENTAL_MATH_GUIDE_GROUPS: MentalMathGuideGroup[] = [
  ...
  },
  {
    ...
    articles: [
      {
        id: 'schulte-overview',
        title: '怎么练舒尔特（成语/词语/古诗词）',
        category: 'schulte',
        practiceModeId: 'schulte-easy',
        blocks: [
          {
            type: 'p',
            text: '快判本地题：开局先出示内容（不计时），再渐显舒尔特方格并按字序点选。成语均为四字、词语均为二字；古诗词素材取自识记模块·诗词模块全部名句。',
          },
          {
            type: 'h3',
            text: '成语 / 词语',
          },
          {
            ...
            items: [
              ...
              '简单题：40 秒，5 行 × 4 列，对 +15 / 错 −30。',
              '普通题：60 秒，6 行 × 4 列，对 +15 / 错 −30（计分同简单）。',
              '复杂题：80 秒，7 行 × 5 列，对 +23 / 错 −45。',
              '题库 500 条（成语与公考双字词语各 250）。',
            ],
          },
          {
            type: 'h3',
          ...
          },
          {
            type: 'ul',
            items: [
              '出示形如「会当凌绝顶，一览众山小——杜甫」；时长按汉字数 ×0.25 秒（含作者名）。',
