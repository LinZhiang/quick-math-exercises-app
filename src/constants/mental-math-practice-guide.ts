    ...
    articles: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '考「能不能整除」「是不是质数」「公因数公倍数」等。先从简单整除口诀练起，数字不会一上来就很大。',
          },
          {
            type: 'h3',
            text: '最常用的整除口诀',
          },
          {
            ...
            items: [
              ...
              '简单题里：最大公约数、质因数分解的数字都不超过 20，方便口算。',
            ],
          },
          {
            type: 'tip',
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '普通、高难题会逐步加大数字，并加入 7、11 与更多质因数 / GCD / LCM；整体仍按口算可及控制，不会一上来就出超大数。',
          },
          {
            type: 'h3',
            text: '小抄',
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              '普通：定状补更常见，句式稍长。',
              '复杂：长单句（逗号延展加长），定状补层层叠叠，把字句 / 被字句更常见；对 +13 / 错 -26。',
            ],
          },
          {
            type: 'tip',
            text: '计分：简单对 +5 / 错 -10，普通 +8 / -15，复杂 +13 / -26。答错进错题集，可对照整句成分解析。先看旁边「句子成分速记」再开练，会轻松很多。',
          },
        ],
      },
      {
