    ...
    articles: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: '快判本地题：开局先出示成语/词语（不计时），再渐显舒尔特方格，按该词字序点选。干扰键为形近/易混字。题库 500 条（成语与公考常用词语各半）。',
          },
          {
            type: 'h3',
            text: '怎么练',
          },
          {
            type: 'ul',
            items: [
              '简单题：40 秒，5 行 × 4 列，对 +10 / 错 −20。',
              '复杂题：80 秒，7 行 × 5 列（纵多横少），对 +15 / 错 −30。',
              '全部点对或点错即停表，公布词条与释义；点「下一题」再进入下一轮预览。',
              '优先出尚未做过的词条，出完后自动重置再循环。',
            ],
          },
          {
            type: 'tip',
            text: '先把词语记牢，格子出现后按字序逐个点选，一次只找下一个字。',
          },
        ],
      },
    ],
