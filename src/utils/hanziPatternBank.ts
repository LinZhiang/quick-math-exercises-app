...
export const HANZI_PATTERN_BANK: HanziPatternBankItem[] = [
  {
    ...
    stem: `三　五　四　伍`,
    correct: "笔画数累加1",
    distractors: ["笔画数累减1","笔画数相等","笔画交叉数相等","上下对称","封闭区域个数相等"],
...
核对：封闭区域 0→1→2→3（经典例）`,
  ...
  },
  {
    ...
    distractors: ["笔画不相连部分个数相等","笔画不相连部分个数累减1","笔画交叉数累减1","笔画数相等","笔画交叉数相等"],
...
核对：不相连部分 1→2→3→4（开/勺/小/心）`,
  ...
  },
  {
    ...
    stem: `王　天　木　人`,
    correct: "都是开放区域",
    distractors: ["封闭区域个数累减1","封闭区域个数累加1","封闭区域个数相等","都有封闭区域","都包含「石」"],
...
核对：封闭区域均为 0`,
  ...
  },
  {
    ...
    stem: `国　回　田　日`,
    correct: "都有封闭区域",
    distractors: ["封闭区域个数相等","封闭区域个数累减1","都是开放区域","封闭区域个数累加1","都包含「心」"],
...
核对：均有封闭区域`,
  ...
  },
  {
    ...
    stem: `林　羽　朋　双`,
    correct: "左右对称",
    distractors: ["上下对称","独体结构","笔画不相连部分个数累减1","笔画数相等","都是开放区域"],
    explanation: `汉字：林、羽、朋、双
规律：左右对称
核对：林/羽/朋/双均为左右对称`,
  ...
  },
  {
    ...
    correct: "左右对称",
    distractors: ["上下对称","独体结构","笔画不相连部分个数累减1","笔画数相等","都是开放区域"],
    explanation: `汉字：贵、林、朋、双
规律：左右对称
核对：贵按教学约定左右对称；贵/林/朋/双`,
  ...
  },
  {
    ...
    stem: `巨　吕　圭　炎`,
    correct: "上下对称",
    distractors: ["左右对称","都包含「石」","笔画不相连部分个数相等","左右结构","都包含「艹」"],
    explanation: `汉字：巨、吕、圭、炎
规律：上下对称
核对：巨/吕/圭/炎均为上下对称（巨=上下对称）`,
  ...
  },
  {
    ...
    stem: `卧　林　河　明`,
    correct: "左右结构",
    distractors: ["半包围结构","上下结构","独体结构","笔画交叉数累加1","都包含「心」"],
...
核对：四字均为左右结构`,
  ...
  },
  {
    ...
    stem: `床　问　这　区`,
    correct: "半包围结构",
    distractors: ["上下结构","左右结构","独体结构","笔画交叉数累减1","都包含「亻」"],
...
核对：四字均为半包围结构`,
  ...
  },
  {
    ...
    stem: `人　木　火　水`,
    correct: "独体结构",
    distractors: ["半包围结构","左右结构","上下结构","都包含「心」","笔画不相连部分个数累加1"],
...
核对：四字均为独体结构`,
  ...
  },
  {
    ...
    stem: `圭　炎　吕　昌`,
    correct: "上下结构",
    distractors: ["半包围结构","左右结构","独体结构","都有封闭区域","都包含「木」"],
...
核对：四字均为上下结构`,
  ...
  },
  {
    ...
    stem: `二　十　丁　七`,
    correct: "笔画数相等",
    distractors: ["笔画数累加1","笔画数累减1","都包含「口」","上下对称","上下结构"],
...
核对：笔画数 1→2→3→4`,
  ...
  },
  {
    ...
    stem: `王　三　二　一`,
    correct: "笔画数累减1",
    distractors: ["笔画数相等","笔画数累加1","独体结构","上下对称","笔画不相连部分个数累减1"],
...
核对：封闭区域 3→2→1→0`,
  ...
  },
  {
    ...
    stem: `一　乙　丁　七`,
    correct: "笔画不相连部分个数相等",
    distractors: ["笔画不相连部分个数累减1","笔画不相连部分个数累加1","左右对称","笔画交叉数累减1","都包含「亻」"],
...
核对：不相连部分 1→2→3→4（开=1/勺=2/小=3）`,
  ...
  },
  {
    ...
    distractors: ["笔画不相连部分个数累加1","笔画不相连部分个数相等","半包围结构","左右结构","都包含「艹」"],
...
核对：不相连部分 4→3→2→1（开=1/勺=2/小=3）`,
  ...
  },
  {
    ...
    stem: `明　休　村　河`,
    correct: "左右结构",
    distractors: ["半包围结构","上下结构","独体结构","笔画数累加1","都包含「木」"],
...
核对：四字均为左右结构`,
  ...
  },
  {
    ...
    stem: `思　想　念　忘`,
    correct: "上下结构",
    distractors: ["半包围结构","左右结构","独体结构","封闭区域个数累减1","都包含「日」"],
...
核对：四字均为上下结构`,
  ...
  },
  {
    ...
    stem: `同　周　风　问`,
    correct: "半包围结构",
    distractors: ["上下结构","左右结构","独体结构","都包含「土」","封闭区域个数相等"],
...
核对：四字均为半包围结构`,
  ...
  },
  {
    ...
    stem: `木　火　水　日`,
    correct: "独体结构",
    distractors: ["半包围结构","左右结构","上下结构","都包含「讠」","笔画不相连部分个数累加1"],
...
核对：四字均为左右轴对称`,
  ...
  },
  {
    ...
    stem: `巨　二　三　吕`,
    correct: "上下对称",
    distractors: ["左右对称","都包含「木」","都包含「石」","左右结构","都包含「氵」"],
    explanation: `汉字：巨、二、三、吕
规律：上下对称
核对：四字均为上下轴对称`,
...
核对：均有封闭区域（1、1、1、2）`,
  ...
  },
  {
    ...
    stem: `天　木　本　未`,
    correct: "都是开放区域",
    distractors: ["都有封闭区域","封闭区域个数累加1","封闭区域个数相等","封闭区域个数累减1","都包含「艹」"],
...
核对：四字均含可见部件「木」`,
  ...
  },
  {
    ...
    stem: `河　江　湖　海`,
    correct: "都包含「氵」",
    distractors: ["都包含「木」","都包含「女」","都包含「钅」","都包含「亻」","都包含「火」"],
...
核对：四字均含可见部件「氵」`,
  ...
  },
  {
    ...
    stem: `吗　呢　呀　吧`,
    correct: "都包含「口」",
    distractors: ["都包含「木」","都包含「氵」","都包含「亻」","都包含「女」","都包含「火」"],
...
核对：四字均含可见部件「口」`,
  ...
  },
  {
    ...
    stem: `二　丁　十　七`,
    correct: "笔画数相等",
    distractors: ["笔画数累减1","笔画数累加1","笔画不相连部分个数累减1","都包含「艹」","独体结构"],
    explanation: `汉字：二、丁、十、七
规律：笔画数相等
核对：笔画数均为 2`,
