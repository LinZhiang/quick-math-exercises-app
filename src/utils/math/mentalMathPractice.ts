...
export const MENTAL_MATH_ARITHMETIC_MODES: MentalMathModeConfig[] = [
  ...
  },
  {
    ...
    wrongDelta: -16,
    maxScore: 100,
    desc: '45 秒 · 个位连加减（3～4 个数，如 7+2−5+1）· 4 选项 · 对 +8 / 错 -16 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'cumsum-hard',
    category: 'arithmetic',
    ...
    wrongDelta: -30,
    maxScore: 100,
    desc: '55 秒 · 个位连加减（5～6 个数）· 强干扰（错位加减/近邻）· 5 选项 · 对 +15 / 错 -30 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'threedigit-easy',
    category: 'arithmetic',
    ...
    wrongDelta: -16,
    maxScore: 100,
    desc: '40 秒 · 三位数加减 · 干扰项个位与正解一致 · 4 选项 · 对 +8 / 错 -16 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'threedigit-hard',
    category: 'arithmetic',
    ...
    wrongDelta: -32,
    maxScore: 100,
    desc: '50 秒 · 三位数加减（含进退位）· 强干扰且个位一致 · 5 选项 · 对 +16 / 错 -32 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'pct-addsub-easy',
    category: 'arithmetic',
  ...
  },
  {
    ...
    wrongDelta: -16,
    maxScore: 100,
    desc: '40 秒 · 两位数 × 一位数 · 干扰项个位与正解一致 · 4 选项 · 对 +8 / 错 -16 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'mulcalc-hard',
    category: 'arithmetic',
    ...
    wrongDelta: -26,
    maxScore: 100,
    desc: '50 秒 · 三位数 × 一位数 · 强干扰且个位一致 · 5 选项 · 对 +13 / 错 -26 · 对 +1 秒 / 错 -1 秒',
  },
  {
    id: 'mixchain-easy',
    category: 'arithmetic',
    ...
    wrongDelta: -24,
    maxScore: 100,
    desc: '45 秒 · 个位乘 + 十位÷个位，再连加减（如 3×4−24÷6+2）· 4 选项 · 对 +12 / 错 −24 · 对 +1 秒 / 错 −1 秒',
  },
  {
    id: 'mixchain-hard',
    category: 'arithmetic',
    ...
    wrongDelta: -32,
    maxScore: 100,
    desc: '55 秒 · 两组乘+一组除 或 两组除+一组乘，再连加减 · 强干扰 · 5 选项 · 对 +16 / 错 −32 · 对 +1 秒 / 错 −1 秒',
  },
]
