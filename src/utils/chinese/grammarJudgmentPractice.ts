...
} from '@/utils/chinese/grammarJudgmentBank'
...
export const GRAMMAR_JUDGMENT_MODES: GrammarJudgmentModeConfig[] = [
  {
    ...
    wrongDelta: -14,
    maxScore: 100,
    desc: '42 秒 · 短句成分 · 句序出题 · 考察对象随机 · 对 +7 / 错 -14',
  },
  {
    ...
    wrongDelta: -20,
    maxScore: 100,
    desc: '52 秒 · 主谓宾定状补齐全 · 句序出题 · 考察对象随机 · 对 +10 / 错 -20',
  },
  {
    ...
    wrongDelta: -30,
    maxScore: 100,
    desc: '62 秒 · 超长单句 · 多层定状补与把被兼语 · 句序出题 · 对 +15 / 错 -30',
  },
]
