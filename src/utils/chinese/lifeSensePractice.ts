...
} from '@/utils/chinese/lifeSenseBank.generated'
...
export const LIFE_SENSE_MODES: LifeSenseModeConfig[] = [
  {
    ...
    wrongDelta: -10,
    maxScore: 100,
    desc: '42 秒 · 去重题库快判 · 按知识点未出优先，出完重置再循环 · 对 +5 / 错 -10',
  },
  {
    ...
    wrongDelta: -15,
    maxScore: 100,
    desc: '52 秒 · 去重题库易混快判 · 按知识点未出优先，出完重置再循环 · 对 +8 / 错 -15',
  },
  {
    id: 'life-sense-hard',
    label: '复杂题',
    ...
    wrongDelta: -20,
    maxScore: 100,
    desc: '62 秒 · 去重题库高频易混 · 按知识点未出优先，出完重置再循环 · 对 +10 / 错 -20',
  },
]
