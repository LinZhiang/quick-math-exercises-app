...
export const FRONTEND_HANDOUT_PHOTO_MAX = 12
...
function asImageList(input: string | string[]): string[] {
  ...
  return list.slice(0, FRONTEND_HANDOUT_PHOTO_MAX)
}
...
export async function extractFrontendHandoutFromPhoto(imageDataUrl: string | string[]): Promise<string> {
