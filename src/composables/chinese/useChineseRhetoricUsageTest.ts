...
import { isAiChatConfigured, requestRhetoricUsageMcqs, DEEPSEEK_NOT_CONFIGURED_HINT } from '@/services/deepseek'
import {
  appendGeneratedTerms,
  listRecentGeneratedTerms,
  type ChineseGeneratedHistoryKind,
} from '@/utils/chinese/chineseGeneratedHistory'
import { upsertChineseRhetoricUsageWrong } from '@/utils/chinese/chineseRhetoricUsageStorage'
...
export function useChineseRhetoricUsageTest() {
  ...
  const wrongGate = createChineseWrongBookGate(upsertChineseRhetoricUsageWrong)
  ...
  function startQuiz(initialQuestions?: RhetoricUsageQuestion[], opts?: { keyReview?: ChineseKeyReviewMeta }) {
