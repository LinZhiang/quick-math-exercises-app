...
import { isAiChatConfigured, requestPartyHistoryMcqs } from '@/services/deepseek'
import {
...
export function useChinesePartyHistoryTest() {
  ...
  function startQuiz(initialQuestions?: PartyHistoryQuestion[]) {
  ...
  async function submitCurrent() {
    ...
    if (!correct) {
      try {
        upsertChinesePartyHistoryWrong(q)
      } catch {
